...
force ace_medical_level = 2;	// advanced medical
...
force ace_medical_painCoefficient = 1.2;	// player pain is 1.2
...
force ace_medical_playerDamageThreshold = 1.3;	// players take 1.3 damage
