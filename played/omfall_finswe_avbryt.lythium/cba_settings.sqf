/*************** ACE3 Settings ***************/
    ...
    force ace_nightvision_effectScaling = 0.6;              // Overall effect
    force ace_nightvision_fogScaling = 1.0;                 // How much fog in terraing
    force ace_nightvision_noiseScaling = 0.6;               // How much noise
