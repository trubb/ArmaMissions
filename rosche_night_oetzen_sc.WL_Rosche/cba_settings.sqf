...
force ace_interation_disableNegativeRating = true;

force ace_map_mapShowCursorCoordinates = true;
force ace_map_gestures_enabled = true;

force ace_medical_ai_enabledFor = 2;	// medical system enabled for ai
force force ace_medical_AIDamageThreshold = 1.3;	// ai can take 1.3 damage
force ace_medical_allowLitterCreation = true;	// crap on the ground is allowed
force ace_medical_allowUnconsciousAnimationOnTreatment = true;	// disallow animation of unconcious peeps
force ace_medical_amountOfReviveLives = -1;	// revive lives disabled
force force ace_medical_bleedingCoefficient = 0.8;	// bleeding is slightly slower than normal
force force ace_medical_blood_enabledFor = 2;	// blood splashes on the ground
...
force ace_medical_delayUnconCaptive = 3;	// standard ai keep shooting at unconcious thing
force force ace_medical_enableAdvancedWounds = false;	// advanced wounds is disabled
...
force ace_medical_enableRevive = 0;	// revive disabled
...
force force ace_medical_level = 2;	// advanced medical
...
force ace_medical_menu_allow = 1;	// medical menu allowed
...
ace_medical_menuTypeStyle = 0;	// 3d selections standard meny type
force ace_medical_moveUnitsFromGroupOnUnconscious = false;	// unconcious units are not removed from the group
force force ace_medical_painCoefficient = 1.2;	// player pain is 1.2
...
force force ace_medical_playerDamageThreshold = 1.3;	// players take 1.3 damage
...
force force ace_medical_useCondition_PAK = 1;	// stable required for PAK use
force force ace_medical_useCondition_SurgicalKit = 1;	// stable required for SK use
...
force ace_weather_windSimulation = false;	// turn off wind simulation
